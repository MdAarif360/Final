...
if selected == 'Home':
    ...
    with col2:
        col2.markdown("# ")
        col2.markdown("# ")
        col2.image("ecomm2.jpg")
        col2.markdown("# ")
        col2.image("ecom.jpg")
        col2.markdown("# ")
        col2.image("ecom3.jpg")

if selected == 'Customers':
    tab1,tab2,tab3 = st.tabs(["$\ EXTRATREESCLASSIFIER $", "$\ RANDOMFORESTCLASSIFIER $", "$\ DECISIONTREECLASSIFIER $"])
...
if selected == 'EDA Analysis':
    ...
    tab1,tab2,tab3 = st.tabs(["$\ CORRELATION MATRIX $", "$\ HISTOGRAM $", "$\ RELATIONSHIP PLOT $"])
